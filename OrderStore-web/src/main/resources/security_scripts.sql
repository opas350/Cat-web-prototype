...
VALUES ('demo','$2a$10$4eqIF5s/ewJwHK1p8lqlFOEm2QIA0S8g6./Lok.pQxqcxaBZYChRm', 'User','Demo','demo@accenture.com');
...
/*
 * Once you are completed the previous step, now you are able login with next credentials
 * User: demo
 * Pwd: abc125 
 * 
 */